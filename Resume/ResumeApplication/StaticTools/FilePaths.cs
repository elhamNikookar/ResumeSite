...
namespace Resume.Application.StaticTools
{
    public static class FilePaths
    {
        ...
        #region SeoTwitterImage
        public static readonly string TwitterImage = $"{BaseImagePath}/MetaTagSeo/origin/";
        public static readonly string TwitterImageServer = Path.Combine(Directory.GetCurrentDirectory(), $"{BaseImagePathServer}/MetaTagSeo/origin/");
        #endregion
